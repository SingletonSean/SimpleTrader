    ...
    public partial class App : Application
    {
        ...
        private IServiceProvider CreateServiceProvider()
        {
            ...
            services.AddSingleton<ISimpleTraderViewModelFactory<LoginViewModel>>((services) => 
                ...
                new ViewModelFactoryRenavigator<PortfolioViewModel>(services.GetRequiredService<INavigator>(), 
                services.GetRequiredService<ISimpleTraderViewModelFactory<PortfolioViewModel>>())));
